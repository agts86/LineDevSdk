...
public class LineSignatureFilterTests
{
    ...
    [Fact]
    public async Task OnActionExecutionAsync_DevelopmentAndVerificationDisabled_SkipsVerification()
    {
        // Arrange
        var inMemorySettings = new Dictionary<string, string> {
            {"Line:VerifySignature", "false"}
        };
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(inMemorySettings)
            .Build();
    ...
    [Fact]
    public async Task OnActionExecutionAsync_DevelopmentAndVerificationEnabled_SkipsVerification()
    {
        // Arrange
        var inMemorySettings = new Dictionary<string, string>();
        var configuration = new ConfigurationBuilder()
    ...
    [Fact]
    public async Task OnActionExecutionAsync_ProductionAndVerificationDisabled_SkipsVerification()
    {
        // Arrange
        var inMemorySettings = new Dictionary<string, string> {
            {"Line:VerifySignature", "false"}
